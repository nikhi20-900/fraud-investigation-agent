...
from app.api.endpoints import health, cases, investigations, graph

app = FastAPI(
    title=settings.PROJECT_NAME,
    version=settings.VERSION,
    description="Backend API service for Agentic Fraud Investigation Agent (Phase 2 — Fraud Data + TigerGraph)",
